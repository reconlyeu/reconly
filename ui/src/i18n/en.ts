...
export const strings = {
  ...
  settings: {
    ...
    agent: {
      title: 'Agent Research Settings',
      description: 'Configure AI research agent behavior including search providers and research parameters.',
      searchSettings: 'Search Settings',
      researchSettings: 'Research Settings',
      settingsSaved: 'Agent settings saved',
      settingsReset: 'Agent settings reset to defaults',
      fields: {
        searchProvider: 'Search Provider',
        searchProviderDescription: 'Default search provider for AI research agents',
        searxngUrl: 'SearXNG URL',
        searxngUrlDescription: 'URL of your self-hosted SearXNG instance',
        tavilyApiKey: 'Tavily API Key',
        tavilyApiKeyDescription: 'API key for Tavily AI-optimized search',
        maxSearchResults: 'Max Search Results',
        maxSearchResultsDescription: 'Maximum number of search results to fetch per query',
        defaultMaxIterations: 'Default Max Iterations',
        defaultMaxIterationsDescription: 'Default maximum research iterations for agent sources',
        gptrReportFormat: 'GPT Researcher Report Format',
        gptrReportFormatDescription: 'Citation style for GPT Researcher reports',
        gptrMaxSubtopics: 'GPT Researcher Max Subtopics',
        gptrMaxSubtopicsDescription: 'Maximum subtopics for GPT Researcher to explore',
      },
    },
