...
class TestOpenAISummarizer(BaseSummarizerTestSuite):
    """Test suite for OpenAISummarizer (inherits contract tests from BaseSummarizerTestSuite)."""

    @pytest.fixture
    def summarizer(self):
        """Return configured OpenAI summarizer instance."""
        return OpenAISummarizer(api_key='test-openai-key-12345')
    ...
    def test_initialization_with_custom_model(self):
        ...
        summarizer = OpenAISummarizer(api_key='test-key', model='gpt-3.5-turbo')
    ...
    def test_estimate_cost_oss_edition(self):
        ...
        summarizer = OpenAISummarizer(api_key='test-key', model='gpt-4-turbo')
    ...
    def test_estimate_cost_consistent_across_models(self):
        ...
        summarizer_gpt4 = OpenAISummarizer(api_key='test-key', model='gpt-4-turbo')
        summarizer_gpt35 = OpenAISummarizer(api_key='test-key', model='gpt-3.5-turbo')
    ...
    def test_get_capabilities(self):
        ...
        caps = OpenAISummarizer.get_capabilities()
    ...
    def test_validate_config_success(self):
        ...
        summarizer = OpenAISummarizer(api_key='test-key-valid', model='gpt-4')
    ...
    def test_summarize_authentication_error(self, mock_openai_class):
        ...
        summarizer = OpenAISummarizer(api_key='invalid-key')
        content_data = self.create_mock_content_data()
    ...
    def test_summarize_model_not_found(self, mock_openai_class):
        ...
        summarizer = OpenAISummarizer(api_key='test-key', model='gpt-nonexistent')
        content_data = self.create_mock_content_data()
    ...
    def test_summarize_different_models(self, mock_openai_class):
        ...
        for model in models:
            summarizer = OpenAISummarizer(api_key='test-key', model=model)
            content_data = self.create_mock_content_data()
    ...
    def test_model_pricing_dictionary(self):
        ...
        pricing = OpenAISummarizer.MODEL_PRICING
